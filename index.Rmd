...
<br>
<a href="https://lpa-4fri.appspot.com/">
<center><img src="http://gdurl.com/0oNZ" alt="Go to the app!" width="600" height="195"></center>
</a>
<br>
...
```
__Figure 5: Values of each LPI against true values after calibration [<mark>TODO</mark>: report fit statistics.].__


[<mark>TODOS</mark>: apply the model to one of the LPIs and show a before/after. Define functions for metrics we're currently missing and generate those too. Restart the CCC (V2?) without NAIP.]
